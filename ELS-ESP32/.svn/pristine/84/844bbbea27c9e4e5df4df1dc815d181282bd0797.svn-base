/*
  ...
  Apache 2 license.
*/
#ifndef TM1638liteEx_h
#define TM1638liteEx_h
...
{
  public:
    TM1638liteEx(uint8_t strobe, uint8_t clock, uint8_t data, bool highFreq, bool clockInverted);    
    ...
    void displayRAW(uint8_t position, uint16_t value);
    void displayASCII(uint8_t position, uint8_t ascii);
    void displayHex(uint8_t position, uint8_t hex);

  private:
   void shiftOutEx(uint8_t dataPin, uint8_t clockPin, uint8_t bitOrder, uint8_t val);
   uint8_t shiftInEx(uint8_t dataPin, uint8_t clockPin, uint8_t bitOrder);
